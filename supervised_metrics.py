...
if __name__ == "__main__":
    gen_folders = "uncertaintity_maps/1.5v/basic/coco/"
    indices = range(10000)
    ...
    pick_score = pickscore(gen_folders, file_indices = filtered)
    hpsv2_score = 2
    ##RM_score = use_RM(gen_folders, file_indices = filtered)
    aes_score = use_AES(gen_folders, file_indices = filtered)

    print(f"pick_score  {pick_score}")
    print(f"hpsv2_score  {hpsv2_score}")
    print(f"aes_score   {aes_score}")
